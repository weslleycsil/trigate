...
var RTCMultiConnection = function (roomid, forceOptions) {
    ...
    function onMessageEvent(message) {
      ...
      if (message.message.allParticipants) {
        ...
        message.message.allParticipants.forEach(function (participant) {
          mPeer[
            !connection.peers[participant] ? "createNewPeer" : "renegotiatePeer"
          ](participant, {
  ...
  function MultiPeers(connection) {
    ...
    this.createNewPeer = function (remoteUserId, userPreferences) {
      ...
      if (
        ...
        !!connection.session.audio &&
        connection.session.audio === "two-way" &&
  ...
  (function () {
    ...
    if (
      ...
      typeof mozRTCPeerConnection !==
        "undefined" /*&& DetectRTC.browser.version > 39*/
    ) {
  ...
  function isUnifiedPlanSuppored() {
    ...
    try {
      ...
      try {
        ...
        else isUnifiedPlanSupported = false;
      } catch (e) {
        isUnifiedPlanSupported = false;
      }
    } catch (e) {
  ...
  function setCordovaAPIs() {
    ...
    if (
      ...
      typeof cordova.plugins.iosrtc === "undefined"
    )
      return;
  ...
  function PeerInitiator(config) {
    ...
    if (
      connection.session.audio == "two-way" ||
      connection.session.video == "two-way" ||
      connection.session.screen == "two-way"
    ) {
      defaults.sdpConstraints = setSdpConstraints({
        OfferToReceiveAudio:
          connection.session.audio == "two-way" ||
          ...
          peer.setLocalDescription(
            ...
            function () {
              ...
              config.onLocalSdp({
                ...
                sdp: localSdp.sdp,
                remotePeerSdpConstraints:
                  config.remotePeerSdpConstraints || false,
                renegotiatingPeer: !!config.renegotiatingPeer || false,
                connectionDescription: self.connectionDescription,
                dontGetRemoteStream: !!config.dontGetRemoteStream,
                extra: connection ? connection.extra : {},
  ...
  var CodecsHandler = (function () {
    ...
    function setOpusAttributes(sdp, params) {
      ...
      appendOpusNext +=
        "; stereo=" +
        (typeof params.stereo != "undefined" ? params.stereo : "1");
      appendOpusNext +=
        "; sprop-stereo=" +
    ...
    if (currentUserMediaRequest.streams[idInstance]) {
      ...
      if (options.localMediaConstraints.isScreen === true) {
        if (navigator.mediaDevices.getDisplayMedia) {
          ...
          throw new Error(
            "getDisplayMedia API is not availabe in this browser."
          );
        }
        return;
      }
  ...
  var FileProgressBarHandler = (function () {
    function handle(connection) {
      ...
      connection.onFileStart = function (file) {
        ...
        progressHelper[file.uuid][file.remoteUserId].progress.max =
          file.maxChunks;
      };
  ...
  (function (connection) {
    ...
    connection.join = function (remoteUserId, options) {
      connection.sessionid =
        (remoteUserId
          ? remoteUserId.sessionid || remoteUserId.remoteUserId || remoteUserId
          : false) || connection.sessionid;
      connection.sessionid += "";
    ...
    function joinRoom(connectionDescription, cb) {
      connection.socket.emit(
        "join-room",
        {
          ...
          extra: connection.extra,
          password:
            typeof connection.password !== "undefined" &&
            typeof connection.password !== "object"
              ? connection.password
              : "",
        },
    ...
    function beforeJoin(userPreferences, callback) {
      ...
      if (
        ...
        session.video !== "two-way" &&
        session.screen !== "two-way"
      ) {
        callback();
        return;
      }
      ...
      audio: {
        ...
        optional: connection.bandwidth.audio
          ? [
              {
                bandwidth:
                  connection.bandwidth.audio * 8 * 1024 || 128 * 8 * 1024,
              },
            ]
          : [],
      },
      video: {
        ...
        optional: connection.bandwidth.video
          ? [
              {
                bandwidth:
                  connection.bandwidth.video * 8 * 1024 || 128 * 8 * 1024,
              },
              {
                facingMode: "user",
              },
    ...
    connection.invokeGetUserMedia = function (
      ...
      getUserMediaHandler({
        onGettingLocalMedia: function (stream) {
          ...
          if (videoConstraints) {
            if (
              videoConstraints.mediaSource ||
              videoConstraints.mozMediaSource
            ) {
              stream.isScreen = true;
            } else if (
    ...
    connection.resetTrack = function (remoteUsersIds, isVideoTrack) {
      ...
      remoteUsersIds.forEach(function (participant) {
        ...
        if (
          (typeof isVideoTrack === "undefined" || isVideoTrack === true) &&
          peer.lastVideoTrack
        ) {
        ...
        if (
          (typeof isVideoTrack === "undefined" || isVideoTrack === false) &&
          peer.lastAudioTrack
        ) {
    ...
    connection.checkPresence = function (roomid, callback) {
      ...
      if (SocketConnection.name === "SSEConnection") {
        SSEConnection.checkPresence(roomid, function (
          isRoomExist,
          _roomid,
          extra
        ) {
      ...
      connection.socket.emit("check-presence", roomid + "", function (
        isRoomExist,
        _roomid,
        extra
      ) {
    ...
    connection.getExtraData = function (remoteUserId, callback) {
      ...
      if (typeof callback === "function") {
        connection.socket.emit(
          ...
          remoteUserId,
          function (extra, remoteUserId, error) {
